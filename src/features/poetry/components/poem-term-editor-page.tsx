              ...
              <form onSubmit={ form.handleSubmit(handleSubmit) } className="space-y-5">
                ...
                <FormField
                  ...
                  render={ ({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription className="text-[#77578f]">
                        The value saved to `poem_term.term_json` is the serialized TipTap document generated by this editor.
                      </FormDescription>
                      <p className="text-sm text-[#77578f]">
                        Supports headings, bold, italic, inline code, lists, blockquotes, links, code blocks, and horizontal rules.
                      </p>
                      <FormMessage />
                    </FormItem>
                  ) }
                ...
                <div className="flex flex-wrap justify-end gap-3 border-t border-[#eee5f5] pt-5">
                  <Button type="button" variant="outline" asChild>
                    <Link href="/poem-terms">Cancel</Link>
                  </Button>
