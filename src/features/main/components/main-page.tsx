      ...
      <section className="font-app px-2 pb-3 md:px-4 md:pb-4">
        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-2 sm:grid-cols-2 md:gap-3">
          ...
          <div className="sm:col-span-2">
            <MainLinkCard isLoggedIn={ memberKeyDetails.isLoggedIn } href="/galleries" src="/images/photo-galleries-wide.png" title="Photo Galleries" tw="rounded-xl border border-green-300 bg-green-500 p-2 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:shadow-lg relative overflow-hidden" />
          </div>
