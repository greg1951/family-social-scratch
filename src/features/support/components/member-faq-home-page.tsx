...
import { memberProfileFaqItems } from "../types/member-profile-constants";
import { useState, useMemo } from "react";
import { HelpCircle, ArrowLeft } from "lucide-react";

export function MemberFaqHomePage({
  defaultCategory = "",
  faqVideos = [],
}: {
  ...
  const faqItems = memberProfileFaqItems;
  ...
  const initialCategory = useMemo(() => {
    const normalizedCategory = defaultCategory.trim();
