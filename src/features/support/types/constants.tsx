...
export const featureFaqItems = [
  ...
  },
  {
    ...
    content: (
      <div className="grid md:grid-cols-1 text-base">
        <span>
          <p className="text-base font-semibold">The Library provides a number of resources to get you going.</p>
          <ol className="list-decimal ml-6 mt-2 text-sm">
  ...
  },
  {
    ...
    trigger: (
      <div>
        ...
        <p className="text-sm text-slate-600">The Library provides a complete book club for the family!</p>
      </div>
    ),
    content: (
      <div className="grid md:grid-cols-1 text-base">
