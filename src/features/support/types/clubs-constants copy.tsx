...
export const clubsFaqItems = [
  {
    value: "item-10",
    category: "Clubs",
    trigger: (
      <div>
        <p className="text-base font-semibold">What are book and poetry clubs all about?</p>
    ...
    content: (
      <div className="grid md:grid-cols-1 text-base">
        <span>
          <p className="text-base font-semibold">Book and Poetry Clubs provide a space for more in-depth conversations and interactions among family members.</p>
          ...
          <ol className="list-decimal ml-6 mt-2 text-sm">
            ...
            <li><u>George</u> further selected a <i>Thumbs Down</i> on poor <u>Greg&apos;s</u> post!</li>
