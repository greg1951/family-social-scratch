  ...
  export const familySocialEmail="support@my-family-social.com";

  export const familySocialHostReference = "https://my-family-social.com";
  ...
  export const familyFeatures = [
    { name: 'TV Room', description: 'Share your favorite TV shows with your family.' },
    { name: 'Movie Theater', description: 'Discuss and recommend movies with your family.' },
    { name: 'Reading Room', description: 'Share and review books with your family.' },
    { name: 'The Kitchen', description: 'Exchange recipes and cooking tips with your family.' },
    { name: 'Music Salon', description: 'Share your favorite music and playlists with your family.' },
    { name: 'Poetry Nook', description: 'Share your love of poetry and creative writing with your family.' },    
    { name: 'Game Room', description: 'Record and track your family\'s game scores, player stats, and leaderboard.' },
    { name: 'Mail Box', description: 'Your family message board and picture sharing platform.' },
  ]
