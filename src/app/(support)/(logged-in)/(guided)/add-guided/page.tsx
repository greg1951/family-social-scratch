...
import AddGuidedForm from "@/features/support/components/add-guided-form";

export default async function AddGuidedPage() {
  ...
  if (memberKeyDetails.isLoggedIn === false || memberKeyDetails.isAdmin === false) {
    console.warn('Unauthorized access attempt to support admin add-guided page. Redirecting to home page.');
    redirect("/");
  }
