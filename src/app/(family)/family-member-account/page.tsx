        ...
        <Card className="flex align-top w-[400] overflow-hidden border-white/70 bg-white/82 pt-0 shadow-[0_28px_90px_-50px_rgba(16,54,74,0.75)] backdrop-blur md:w-[700]">
          <CardHeader className="rounded-[1.35rem] bg-[linear-gradient(135deg,#59cdf7_0%,#9de4fe_45%,#fff2d8_100%)] px-6 pb-5 pt-5 shadow-[inset_0_-1px_0_rgba(255,255,255,0.45)]">
            <div className="grid gap-4 md:grid-cols-[minmax(0,1fr)_auto] md:items-start">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-white/65 bg-white/55 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.24em] text-[#005472] shadow-sm backdrop-blur">
                  <Sparkles className="h-3.5 w-3.5" />
                  Your Space
                </div>
                <CardTitle className="mt-3 text-2xl font-extrabold tracking-[0.02em] text-[#10364a] md:text-[2rem]">My Account</CardTitle>
                <div className="pt-1">
                  <CardDescription className="max-w-2xl text-sm leading-6 text-[#315363]">
