...
export default async function MusicDiscussionThreadPage({
  params,
}: {
  ...
  return (
    <section className="font-app w-full px-4 pb-10 pt-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="overflow-hidden rounded-[1.9rem] border border-white/70 bg-white/90 shadow-[0_24px_70px_-40px_rgba(60,20,0,0.75)]">
          ...
          { thread.postsAndReplies.length === 0 ? (
            <div className="px-5 py-5 sm:px-6">
              <InitialPostComposer
                ...
                revalidatePaths={ ["/music", `/music/discussions/${ thread.id }`] }
              />
            </div>
          ) : (
