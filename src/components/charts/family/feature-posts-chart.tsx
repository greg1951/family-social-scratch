...
const chartConfig = {
  ...
  ALBUM_SHARED: { label: "Albums", color: "#fbbf24" },
    ...
    <>
      <CardHeader className="flex-row items-start space-y-0 pt-0">
        <div className="grid gap-1">
          <CardTitle className="text-center text-sm font-semibold">Feature Posts</CardTitle>
        </div>
      </CardHeader>
      <CardContent className="flex flex-1 justify-center">
        <ChartContainer config={ chartConfig } className="mx-auto h-72 w-full min-w-0">
          <BarChart accessibilityLayer data={ data } margin={ { top: 56, left: 12, right: 12 } }>
            ...
            <Bar dataKey="ALBUM_SHARED" stackId="a" fill="#fbbf24" radius={ [0, 0, 0, 0] } />
