        ...
        <Container style={ { padding: '20px' } } className='mx-auto rounded-lg border border-brandBorder bg-brandPanel px-8 py-6'>
          <Section className='mb-4'>
            <Row>
              ...
              <Column align='left' valign='middle' style={ { width: '630px' } }>
                <Text className='pt-2 m-0 font-app text-base leading-6'>
                  Good News, { memberName }! You have been invited by 👉{ founderName }👈 to join the &quot;{ familyName }&quot; on the My Family Social platform.
                </Text>
            ...
            <Row>
              <Column align='left' valign='top' style={ { width: '620px', paddingRight: '20px' } }>
                <Text className='m-0 font-app text-base leading-6'>
                  What is My Family Social you ask? It is a site dedicated to helping families stay connected and share family news, photos, movie and TV reviews,
            ...
            <Row>
              <Column align='left' valign='top'>
                <Text className='m-0 mb-4 pt-2 text-left font-app text-base leading-6'>
                  ...
                  <i>TV Room, Movie Theater, Music Salon, The Kitchen, Reading Room, Poetry Nook, Family Game Scoreboard</i>, and more!
                </Text>
