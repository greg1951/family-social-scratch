...
CREATE TABLE "family_schema"."music" (
	...
	"music_type" text DEFAULT 'album' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "family_schema"."music_playlist_media" (
	"id" serial PRIMARY KEY NOT NULL,
	"media_source" text DEFAULT '' NOT NULL,
	"media_type" text DEFAULT 'song' NOT NULL,
	"media_url" text DEFAULT '' NOT NULL,
	"media_artist" text DEFAULT '' NOT NULL,
	"media_caption" text DEFAULT '' NOT NULL,
	"created_at" timestamp DEFAULT now(),
	"fk_music_id" integer NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "family_schema"."music_playlist_media" ADD CONSTRAINT "music_playlist_media_fk_music_id_music_id_fk" FOREIGN KEY ("fk_music_id") REFERENCES "family_schema"."music"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "blog_post_tag_tag_id_idx" ON "family_schema"."blog_post_tag" USING btree ("fk_blog_tag_id");--> statement-breakpoint
...
CREATE INDEX "music_media_music_id_idx" ON "family_schema"."music_playlist_media" USING btree ("fk_music_id");--> statement-breakpoint
