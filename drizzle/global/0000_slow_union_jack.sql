CREATE TABLE "global_schema"."blog_tag_reference" (
	"id" serial PRIMARY KEY NOT NULL,
	"tag_name" text NOT NULL,
	"category" text DEFAULT 'general' NOT NULL,
	"seq_no" integer DEFAULT 1 NOT NULL,
	"created_at" timestamp DEFAULT now(),
	CONSTRAINT "blog_tag_reference_name_uq" UNIQUE("tag_name")
);
...
CREATE TABLE "global_schema"."guided_tour_reference" (
	...
	"status" text DEFAULT 'draft' NOT NULL,
	"audience_type" text DEFAULT 'member' NOT NULL,
...
CREATE INDEX "blog_tag_reference_name_idx" ON "global_schema"."blog_tag_reference" USING btree ("tag_name");--> statement-breakpoint
